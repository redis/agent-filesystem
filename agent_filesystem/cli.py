"""Agent Filesystem CLI - thin wrapper over FS.* commands."""
...
def get_fs(ctx, key: str) -> AgentFilesystem:
    """Get AgentFilesystem instance."""
    return AgentFilesystem(get_redis(ctx), key)
...
def cli(ctx, host, port, db, url):
    """Agent Filesystem: Filesystem operations in Redis.
