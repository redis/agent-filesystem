...
- [mount/internal/client/client.go](/Users/rowantrollope/git/agent-filesystem/mount/internal/client/client.go)
- [mount/internal/client/native.go](/Users/rowantrollope/git/agent-filesystem/mount/internal/client/native.go)
- [mount/internal/client/keys.go](/Users/rowantrollope/git/agent-filesystem/mount/internal/client/keys.go)
...
```bash
agent-filesystem-mount --workspace my-repo --session fix-login /mnt
agent-filesystem-nfs --workspace my-repo --session fix-login ...
```

Or equivalently:

```bash
agent-filesystem-mount --key my-repo --session fix-login /mnt
```
...
- [cli/mount_backend.go](/Users/rowantrollope/git/agent-filesystem/cli/mount_backend.go)
- [mount/internal/redisfs/fs.go](/Users/rowantrollope/git/agent-filesystem/mount/internal/redisfs/fs.go)
...
- [sandbox/internal/api/mcp_tools.go](/Users/rowantrollope/git/agent-filesystem/sandbox/internal/api/mcp_tools.go)
- [redisclaw/redisclaw/agent.py](/Users/rowantrollope/git/agent-filesystem/redisclaw/redisclaw/agent.py)
...
- [BACKLOG.md](/Users/rowantrollope/git/agent-filesystem/BACKLOG.md#L82)
- [BACKLOG.md](/Users/rowantrollope/git/agent-filesystem/BACKLOG.md#L88)
- [BACKLOG.md](/Users/rowantrollope/git/agent-filesystem/BACKLOG.md#L101)
