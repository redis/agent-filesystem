...
func cmdWorkspaceVersioning(args []string) error {
	rewritten := make([]string, 0, len(args))
	rewritten = append(rewritten, "versioning")
	if len(args) > 2 {
		rewritten = append(rewritten, args[2:]...)
	}
	return cmdVersioning(rewritten)
}
